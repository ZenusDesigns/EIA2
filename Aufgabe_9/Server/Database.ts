...
if (process.env.NODE_ENV == "production") {
    databaseURL = "mongodb+srv://testuser:testuser123456@icedealermarkv-xgkle.mongodb.net/StudiData";
...
export function MatrikelSearch(_matrikel: number, _callback: Function): void {
